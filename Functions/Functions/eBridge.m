...
%electrical bridge.
%
% Website : https://psychophysiology.cpmc.columbia.edu/software/eBridge/index.html
%
%Please cite as: Alschuler DM, Tenke CE, Bruder GE, Kayser J. (2014). Identifying electrode bridging from electrical distance distributions: a survey of publicly-available EEG data using a new method. Clinical Neurophysiology, 125(3), 484-490. doi:10.1016/j.clinph.2013.08.024
%
