...
function  [art, horiz, vert, blink, disc,soglia_DV, diff_var, soglia_K,...
    med2_K, meanK, soglia_SED, med2_SED, SED, soglia_SAD, med2_SAD, SAD, ...
soglia_GDSF, med2_GDSF, GDSF, soglia_V, med2_V, maxvar, soglia_D,maxdin, EEG] = interface_ADJ (EEG,report)
